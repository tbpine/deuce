...
BEGIN
    ...
    `team_size`, `custom_games`,`no_singles`,`no_doubles`, `group_size`
...
INSERT INTO `tournament_detail`(`tournament`,`no_entries`,`sets`,`games`,`custom_games`,`team_size`,`no_singles`,`no_doubles`, `updated_datetime`,`created_datetime`, `group_size`) 
VALUES (p_tournament, p_no_entries, p_sets, p_games, p_custom_games, p_team_size, p_no_singles, p_no_doubles, NOW(), NOW(), p_group_size)
ON DUPLICATE KEY UPDATE `no_entries` = p_no_entries,`sets` = p_sets, `games` = p_games, `custom_games` = p_custom_games,
`team_size` = p_team_size, `no_singles` = p_no_singles , `no_doubles` = p_no_doubles, `updated_datetime` = NOW(), `group_size` = p_group_size;
